...
import { DollarSign, FileText, Users, AlertCircle, TrendingUp, Calendar, Clock } from 'lucide-react';
        ...
        <div className="space-y-4 lg:space-y-6">
          ...
          <div className="bg-white rounded-xl border border-gray-200 p-4 lg:p-6">
            ...
            <div className="space-y-3">
              ...
              <button className="w-full text-left px-3 py-2 text-sm text-green-600 hover:bg-green-50 rounded-lg transition-colors duration-200">
                + Tambah Klien
              </button>
          ...
          <div className="bg-gradient-to-r from-blue-500 to-blue-600 rounded-xl p-4 lg:p-6 text-white">
            <div className="flex items-center justify-between mb-2">
